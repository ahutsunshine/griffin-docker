...
rm jdk8-linux-x64.tar.gz hadoop-2.6.5.tar.gz scala-2.10.6.tgz spark-1.6.0-bin-hadoop2.6.tgz apache-hive-1.2.2-bin.tar.gz livy-server-0.3.0.zip

#remove extra files
rm -rf hadoop/share/doc
rm spark/lib/spark-examples*.jar
